...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/addison/ROS_Primer/catkin_ws/install/${idir}'.  Ask the maintainer 'addison <addison@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/addison/ROS_Primer/catkin_ws/install/lib;/home/addison/ROS_Primer/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
